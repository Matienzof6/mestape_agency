...
if not DEBUG:
    ...
    DEFAULT_FROM_EMAIL='Mestape - Software Agency <mail@mestape.com>'
    ...
    AWS_SECRECT_ACCESS_KEY = env('AWS_SECRECT_ACCESS_KEY')
    ...
    STATICFILES_STORAGE = 'core.storages_backends.StaticRootS3BotoStorage'

    #s3 public media settings
    PUBLIC_MEDIA_LOCATION = 'media'
    MEDIA_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/{PUBLIC_MEDIA_LOCATION}/'
    DEFAULT_FILE_STORAGE = 'core.storage_backends.MediaRootS3BotoStorage'
