...
class Post(models.Model):
    ...
    category =      models.ForeignKey(Category, on_delete=models.PROTECT, blank=True, null=True)  # Si se borra la categoria, el protect hace que no se borren los posts con el y visceversa
