    ...
    return(
        ...
        <div className="mx-auto max-w-full py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <img 
              ...
              <p className="text-base text-gray-500">
                Texto para poner debajo del logo
              </p>
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            <p className="text-base text-gray-400 xl:text-center">&copy; 2023 Sitio diseñado por <a href='https://linkedin.com/in/matias-pereiro' target='_blank' rel="noreferrer">Maty Pereiro</a>.</p>
          </div>
        </div>
      </footer>
    )
